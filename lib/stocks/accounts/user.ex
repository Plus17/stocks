defmodule Stocks.Accounts.User do
  use Ecto.Schema
  import Ecto.Changeset

  alias Stocks.Schemas.Users.Settings
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Stocks.Repo)
  ...
  """
  def valid_password?(%Stocks.Accounts.User{hashed_password: hashed_password}, password)
